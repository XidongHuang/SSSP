...
<script type="text/javascript">
	...
	$(".delete").click(function(){
		...
		var flag = confirm("Are you sure to delete: " + label + "'s information?");
		...
		<table border="1" cellpadding="10" cellspacing="0">
			...
			<tr>
				<td colspan="8">
					...
					Total ${page.totalPages } pages
					Current ${page.number + 1} page
					<a href="?pageNo=${page.number +1 -1 }">Last Page</a>
					<a href="?pageNo=${page.number +1 +1 }">Next Page</a>
				</td>
			</tr>
		</table>
	</c:if>
